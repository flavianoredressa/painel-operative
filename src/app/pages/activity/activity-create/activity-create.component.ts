...
export class ActivityCreateComponent implements OnInit {
  ...
  async ngOnInit() {
    try {
      if (this.idActivity) {
        ...
        const statusSale = await this.activityRepository.getUserById(this.idActivity);
  ...
  async handleSubmit() {
    ...
    try {
      ...
      this.toastrService.success(`Atividades ${!this.idActivity ? 'cadastrado' : 'atualizado'} com sucesso.`);
